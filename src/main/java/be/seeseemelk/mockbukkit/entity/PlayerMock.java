...
public class PlayerMock extends EntityMock implements Player
{
    ...
    private final Map<Attribute, AttributeInstanceMock> attributes = new EnumMap<>(Attribute.class);
     ...
     * However, if {@code getInstaBreak} is enabled, it will not automatically fire
    ...
    {
        Map<DamageModifier, Double> modifiers = createDefaultDamageModifiers();
        Map<DamageModifier, Function<Double, Double>> modifierFunctions = createDefaultDamageModifierFunctions();
    ...
    private Map<DamageModifier, Double> createDefaultDamageModifiers()
    {
    ...
    private Map<DamageModifier, Function<Double, Double>> createDefaultDamageModifierFunctions()
    {
    ...
    {
        AsyncPlayerChatEvent eventAsync = new AsyncPlayerChatEvent(false, this, msg, new HashSet<>(Bukkit.getOnlinePlayers()));
        PlayerChatEvent eventSync = new PlayerChatEvent(this, msg);
        Bukkit.getScheduler().runTaskAsynchronously(null, () -> Bukkit.getPluginManager().callEvent(eventAsync));
