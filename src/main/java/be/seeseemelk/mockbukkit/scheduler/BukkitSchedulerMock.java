...
public class BukkitSchedulerMock implements BukkitScheduler
{
    ...
    private final Logger logger = Logger.getLogger("BukkitSchedulerMock");
    ...
    {
        ScheduledTask scheduledTask = new ScheduledTask(id++, plugin, true, currentTick + delay, (t) -> task.run());
    ...
    {
        logger.warning("Consider using runTask instead of scheduleSyncDelayTask");
    ...
    public BukkitTask runTaskAsynchronously(Plugin plugin, Runnable task) throws IllegalArgumentException
    {
        ScheduledTask scheduledTask = new ScheduledTask(id++, plugin, false,
                currentTick, t -> new AsyncRunnable(task).run());
        asyncTasksRunning.incrementAndGet();
    ...
    {
        ScheduledTask scheduledTask = new ScheduledTask(id++, plugin, false,
                currentTick + delay, t -> new AsyncRunnable(task).run());
        tasks.add(scheduledTask);
        asyncTasksQueued++;
        return scheduledTask;
    }
