...
import be.seeseemelk.mockbukkit.enchantment.Enchantments;
...
public class ServerMock implements Server
{
    ...
    public ServerMock()
    {
        ...
        Enchantments.registerAllEnchantmentMocks();
    ...
    {
        assertMainThread();
        return players.stream().filter(player -> player.getName().toLowerCase(Locale.ENGLISH).startsWith(name.toLowerCase()))
