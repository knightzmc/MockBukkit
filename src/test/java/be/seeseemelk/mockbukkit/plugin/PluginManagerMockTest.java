...
public class PluginManagerMockTest {
    ...
    @Test
    public void callEvent_RegisteredPlayerInteractEvent_eventExecutor_OneCalled() {
        PlayerInteractEvent event = new PlayerInteractEvent(null, null, null, null, null);
        pluginManager.registerEvent(PlayerInteractEvent.class, plugin, EventPriority.NORMAL,
                (l, e) -> plugin.onPlayerInteract((PlayerInteractEvent) e), plugin);
